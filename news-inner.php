...
<main>
    ...
    <div class="container">
      <div class="flexwrap">
        <div class="breadcrumbs">
          ...
          <a class="btn__breadcrumb" href="">Naujienos</a>
          <a class="btn__breadcrumb" href="">Naujienos pavadinimas</a>
        </div>
        <div class="go-back">
  ...
  <section class="section inner text-content">
    <div class="container">
      <div class="inner-hero">
        <div class="inner-hero__wrap">
          <div class="inner-hero__bg" style="background-image: url(./assets/images/AnimalShelter.jpg)"></div>
