<header class="header">
  <div class="container">
    <div class="header__top">
      <a class="header__top__item header__top__item--first btn btn--orange btn--xl" href="#">Paremkite mus</a>
    ...
    <div class="header__bottom">
      <ul class="header__navigation header__navigation__left">
        <li class="header__navigation__item"><a class="header__navigation__link" href="#">Globotiniai</a></li>
        <li class="header__navigation__item"><a class="header__navigation__link" href="#">Parama</a></li>
