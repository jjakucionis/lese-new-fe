...
<main>
  <section class="section hero">
    <div class="hero__cont swiper-container">
      <div class="hero__cont__wrapper swiper-wrapper">
          <!-- Slides -->
          <div class="hero__slide swiper-slide">
            <div class="hero__slide__background" style="background-image: url('./assets/images/hero1.png')"></div>
            <div class="hero__slide__content">
              <h2 class="hero__slide__content__title">Paremk beglobius gyvūnus</h2>
              <a class="btn__common btn--orange hero__slide__content__btn" href="#">Paaukoti</a>
            </div>
          </div>
          <div class="hero__slide swiper-slide">
            <div class="hero__slide__background" style="background-image: url('./assets/images/hero2.jpg')"></div>
            <div class="hero__slide__content">
              <h2 class="hero__slide__content__title">Tapk vienu iš mūsų super savanorių</h2>
              <a class="btn__common btn--orange hero__slide__content__btn" href="#">Daugiau informacijos</a>
            </div>
          </div>
      </div>
